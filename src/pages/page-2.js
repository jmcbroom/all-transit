...
const SecondPage = () => (
  <Layout>
            ...
            <List>
              ...
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>Know before you go</List.Description>
                </List.Content>
              </List.Item>
              <List.Item>
                <List.Icon name="angle right" />
            ...
            <List>
              ...
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>Access real-time info</List.Description>
                </List.Content>
              </List.Item>
              <List.Item>
                <List.Icon name="angle right" />
    ...
    <Segment basic>
      <Grid centered>
        <Grid.Row>
          <Button size="big" centered color="purple">
            GO FURTHER
          </Button>
        </Grid.Row>
      </Grid>
